...
<head>
<meta charset="utf-8">
<fmt:setBundle basename="cn.hyj.web.info.Info" />
		...
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img
					src="assets/img/logo.png" width="35" height="35" alt=""> <span><fmt:message key="Preclinic"></fmt:message></span>
				</a>
			</div>
			...
			<ul class="nav user-menu float-right">
								...
								<li class="notification-message"><a href="activities.html">
										<div class="media">
											<span class="avatar"> <img alt="John Doe"
												src="assets/img/user.jpg" class="img-fluid">
											</span>
				...
				<li class="nav-item dropdown d-none d-sm-block"><a
					...
					class="hasnotifications nav-link"><i class="fa fa-comment-o"></i>
						<span class="badge badge-pill bg-danger float-right">8</span></a></li>
				<li class="nav-item dropdown has-arrow"><a href="#"
					class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
						<span class="user-img"><img class="rounded-circle"
							src="assets/img/user.jpg" width="40" alt="Admin"> <span
			...
			<div class="dropdown mobile-user-menu float-right">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="profile.html"><fmt:message key="MyProfile"></fmt:message></a> <a
						class="dropdown-item" href="edit-profile.html"><fmt:message key="EditProfile"></fmt:message></a> <a
						class="dropdown-item" href="settings.html"><fmt:message key="Settings"></fmt:message></a> <a
						class="dropdown-item" href="login.html"><fmt:message key="Logout"></fmt:message></a>
				</div>
			</div>
		</div>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li><a href="index.html"><i class="fa fa-dashboard"></i><span><fmt:message key="Dashboard"></fmt:message></span></a></li>
						<li><a href="doctortomain.do"><i class="fa fa-user-md"></i>
								<span><fmt:message key="Doctors"></fmt:message></span></a></li>
						<li><a href="patientstomain.do"><i
								class="fa fa-wheelchair"></i> <span><fmt:message key="Patients"></fmt:message></span></a></li>
						<li><a href="appointmenttomain.do"><i class="fa fa-calendar"></i>
								<span><fmt:message key="Appointments"></fmt:message></span></a></li>
						<li><a href="schedule.html"><i
								class="fa fa-calendar-check-o"></i> <span><fmt:message key="DoctorSchedule"></fmt:message></span></a>
						</li>
						<li><a href="departments.html"><i
								class="fa fa-hospital-o"></i> <span><fmt:message key="Departments"></fmt:message></span></a></li>
						<li class="submenu"><a href="#"><i class="fa fa-user"></i>
								<span> Employees </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="employees.html"><fmt:message key="employee"></fmt:message></a></li>
						...
						<li><a href="chat.html"><i class="fa fa-comments"></i> <span><fmt:message key="Chat"></fmt:message></span><span class="badge badge-pill bg-primary float-right">5</span></a>
						</li>
						
						<li class="submenu"><a href="#"><i class="fa fa-envelope"></i>
						...
						<li class="submenu"><a href="#"><i class="fa fa-laptop"></i>
								<span> Components</span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="uikit.html">UI Kit</a></li>
								<li><a href="typography.html">Typography</a></li>
								<li><a href="tabs.html">Tabs</a></li>
							</ul></li>
						<li class="submenu"><a href="#"><i class="fa fa-edit"></i>
						...
						<li class="submenu"><a href="#"><i class="fa fa-table"></i>
						...
						<li class="submenu"><a href="#"><i class="fa fa-columns"></i>
						...
						<li class="submenu"><a href="javascript:void(0);"><i
								class="fa fa-share-alt"></i> <span>Multi Level</span> <span
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table
								...
								<tbody>
									<c:forEach items="${lu}" var="str">
										<tr>
											<td><img width="28" height="28"
												src="assets/img/user.jpg" class="rounded-circle m-r-5"
												alt="">${str.patient_id}</td>
											<td>${str.patient_name}</td>
											<td>${str.patient_age}</td>
											<td>${str.patient_sex}</td>
											<td>${str.patient_phone}</td>
											<td>${str.patient_email}</td>
												...
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item"
															href="patienttomodify.do?patient_id=${str.patient_id}">
															<i class="fa fa-pencil m-r-5"></i>Edit
														</a> <a class="dropdown-item"
															href="patientdelete.do?patient_id=${str.patient_id}"
															onclick="javascript:return del();"> <!-- data-toggle="modal" data-target="#delete_patient"  -->
